var util = require('../util'),
    ...
    RequestProtocol = require('./request-protocol').RequestProtocol,
 ...
 * @property {Protocol~definition} protocol The protocol information for this request.
 */
_.inherit((
...
_.assign(Request.prototype, /** @lends Request.prototype */ {
    ...
    update: function (options) {
        ...
        _.mergeDefined(this, /** @lends Request.prototype */ {
             ...
             */
            protocol: options.protocol && new RequestProtocol(options.protocol)
        });
    },
